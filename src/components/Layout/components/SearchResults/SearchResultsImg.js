    ...
    return (
        <div>
            <div className="relative">
                ...
                ></div>
                <h1 className="translate-y-1/2 pl-4 text-6xl text-white absolute inset-y-1/2">
                    Search results for:
                </h1>
            </div>
            ...
            <div className="flex justify-center pt-16">
                <div className="flex border border-purple-200 rounded-lg">
                    <input
                        type="text"
                        className="w-96 block w-full px-4 py-2 text-purple-700 bg-white border rounded-lg focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                        placeholder="Search..."
                    />
            ...
            <div className='pt-16 space-x-16 max-w-[1240px] mx-auto pt-16 px-4 text-center'>
